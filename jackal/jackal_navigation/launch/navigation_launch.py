...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument(
            'params_file',
            default_value=os.path.join(bringup_dir, 'config', 'nav3.yaml'),
    ...
    #     ExecuteProcess(
    #         cmd=['ros2', 'lifecycle', 'set', '/recoveries_server', 'configure'],
    #         output='screen'
    #     ),
    ...
    #     ExecuteProcess(
    #         cmd=['ros2', 'lifecycle', 'set', '/recoveries_server', 'activate'],
    #         output='screen'
    #     ),
