...
from launch import LaunchDescription # ROS2 node 
...
from launch.substitutions import LaunchConfiguration, PathJoinSubstitution # launch variable, path setting
...
def generate_launch_description():
    ...
    declare_map_yaml_cmd = DeclareLaunchArgument(
        "map",
        default_value=PathJoinSubstitution([pkg_jackal_navigation, "maps", "hri_lab.yaml"]),
    ...
    declare_params_file_cmd = DeclareLaunchArgument(
        "params_file",
        default_value=PathJoinSubstitution([pkg_jackal_navigation, "config", "nav3hri.yaml"]),
